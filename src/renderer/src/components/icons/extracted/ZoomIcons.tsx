...
/** Codex `Xh` —— Zoom in(plus) */
export function ZoomInIcon({ className, 'aria-hidden': ariaHidden }: IconProps): React.JSX.Element {
  return (
    <svg
      className={className}
      aria-hidden={ariaHidden}
