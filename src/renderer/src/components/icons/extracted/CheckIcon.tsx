...
/** chat.html 弹层选项的选中勾选图标（rcheck） */
export function CheckIcon({ className, 'aria-hidden': ariaHidden }: IconProps): React.JSX.Element {
  return (
    <svg className={className} aria-hidden={ariaHidden} viewBox="0 0 17 17" fill="none">
      <path
