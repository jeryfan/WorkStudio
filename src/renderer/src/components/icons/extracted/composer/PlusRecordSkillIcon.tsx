...
export function PlusRecordSkillIcon({ className }: IconProps): React.JSX.Element {
  return (
    <svg
      width="20"
      height="20"
    ...
    >
      <g transform="scale(1.25)">
        <path d="M8.00195 4.1416C10.1326 4.14173 11.8602 5.86933 11.8604 8C11.8602 10.1307 10.1327 11.8583 8.00195 11.8584C5.87129 11.8582 4.14369 10.1307 4.14355 8C4.14373 5.86936 5.87131 4.14178 8.00195 4.1416Z"></path>
        <path
          fillRule="evenodd"
          clipRule="evenodd"
