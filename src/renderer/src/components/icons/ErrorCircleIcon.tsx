...
/**
 * Codex 的错误指示图标(bundle 里的 `sA`)—— 21×21 圆圈加感叹号,
 * 会话行 systemError 时出现在**前导槽**(行首),配 `text-token-error-foreground`。
 */
export function ErrorCircleIcon({ className }: IconProps): React.JSX.Element {
  return (
    <svg
      width="21"
      height="21"
