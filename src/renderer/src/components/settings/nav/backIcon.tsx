...
/**
 * 设置侧栏 "Back to app" 那一行的箭头 —— Codex `t8`（内部 BM），
 * 20×20、单条 path、fill=currentColor，从产物原样提取。
 */
export function BackToAppIcon(props: SVGProps<SVGSVGElement>): React.JSX.Element {
  return (
    <svg
      width={20}
      height={20}
